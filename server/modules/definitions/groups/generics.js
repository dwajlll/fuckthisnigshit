const { skillSet, combineStats } = require('../facilitators.js');
...
Class.genericLancer = {
    ...
    IS_IMMUNE_TO_TILES: false,
    REROOT_UPGRADE_TREE: "basic",
    STAT_NAMES: statnames.lanceStat,
    BODY: {
        ACCELERATION: base.ACCEL,
        SPEED: base.SPEED,
        HEALTH: base.HEALTH,
...
Class.fallenTank = {
    ...
    FACING_TYPE: "toTarget",
    HITS_OWN_TYPE: "hardOnlyBosses",
    BROADCAST_MESSAGE: "A fallen tank has been defeated!",
    BODY: { PUSHABILITY: 0.05 }
}
