        ...
        if (
            ...
            if (this.color.base == '-1' || this.color.base == 'mirror') {
                if (Config.GROUPS || (Config.MODE == 'ffa' && !Config.TAG)) {
                    this.color.base = this.isBot ? "veryLightGrey" : getTeamColor(TEAM_RED);
                } else {
    ...
    move() {
        ...
        switch (this.motionType) {
            ...
            case "slowgrow":
                ...
                break;
            case "slowestgrow":
                this.SIZE += this.motionTypeArgs.growSpeed ?? 0.25;
                break;
            case "flamethrower":
                this.maxSpeed = this.topSpeed;
                this.damp = -0.02;
            ...
            case "explode":
                ...
                break;
            case "midgrow":
                this.SIZE += this.motionTypeArgs.growSpeed ?? 3;
                break;
            case "fastgrow":
    ...
    face() {
        ...
        switch (this.facingType) {
            ...
            case "autospin":
                ...
                break;
            case "oldSpikeSpin1":
                this.facing += (this.facingTypeArgs.speed ?? 0.3) / Config.runSpeed;
                break;
            case "oldSpikeSpin2":
                this.facing -= (this.facingTypeArgs.speed ?? 0.2) / Config.runSpeed;
                break;
            case "spinSlowly":
                this.facing += (this.facingTypeArgs.speed ?? 0.0075) / Config.runSpeed;
                break;
            case "spin":
